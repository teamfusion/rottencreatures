...
import com.github.teamfusion.rottencreatures.client.rendering.model.blockentities.*;
import com.github.teamfusion.rottencreatures.client.rendering.model.entities.*;
...
public class ClientSetup {
    ...
    public static void modelLayerRegistry(GameRendering.ModelLayerEvent event) {
        ...
        event.register(RCModelLayers.HUNTER_WOLF, WolfModel::createBodyLayer);
