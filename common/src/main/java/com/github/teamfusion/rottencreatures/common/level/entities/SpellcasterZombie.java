    ...
    protected class CastingSpellGoal extends Goal {
        ...
        public void tick() {
            if (SpellcasterZombie.this.getTarget() != null) {
                SpellcasterZombie.this.getLookControl()
                    .setLookAt(SpellcasterZombie.this.getTarget(), (float) SpellcasterZombie.this.getMaxHeadYRot(), (float) SpellcasterZombie.this.getMaxHeadXRot());
            }
        }
    }
