...
public class Scarab extends PathfinderMob {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_IS_LANDING, false);
    ...
    public void tick() {
        ...
        if (this.isFlying() && this.isOnGround() && !this.isLanding()) {
            setLanding(true);
            setFlying(false);
        }
        ...
        if (this.isFlying()) {
            ...
            if (!this.isOnGround() && this.getDeltaMovement().y < 0.0) {
                this.setDeltaMovement(this.getDeltaMovement().multiply(1.0, 0.6, 1.0));
            }
        } else {
            // Not flying - check if we should start flying
            if (!this.isLanding() && this.isOnGround()) {
