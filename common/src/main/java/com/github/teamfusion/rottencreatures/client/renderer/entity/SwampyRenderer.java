...
public class SwampyRenderer extends HumanoidMobRenderer<Swampy, SwampyModel> {
    public static final ModelLayerLocation MAIN = ModelBuilder.createLayer(RCEntityTypes.SWAMPY.get());
    public static final ModelLayerLocation INNER_ARMOR = ModelBuilder.createLayer(RCEntityTypes.SWAMPY.get(), "inner_armor");
    public static final ModelLayerLocation OUTER_ARMOR = ModelBuilder.createLayer(RCEntityTypes.SWAMPY.get(), "outer_armor");
