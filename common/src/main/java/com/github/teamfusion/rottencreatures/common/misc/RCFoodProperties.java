...
public class RCFoodProperties {
    ...
    public static FoodProperties register(int nutrition, float saturation, boolean meat, boolean alwaysEat, boolean fastFood, Supplier<MobEffectInstance> effect, float probability) {
