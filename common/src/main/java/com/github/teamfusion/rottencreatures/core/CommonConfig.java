...
public class CommonConfig {
    ...
    public final ConfigBuilder.ConfigValue<Double> immortalChance;
    ...
    public CommonConfig(ConfigBuilder builder) {
        ...
        this.immortalChance = builder.comment("determine the chance of spawning for Immortals").define("immortalChance", 0.025);
    }
}