...
public class RCPotions {
    ...
    // ========== CORRUPTED POTIONS ====================================================================================
    public static final Supplier<Potion> CORRUPTED = create(
            "corrupted",
            Potion::new
    );

    // ========== FREEZE POTIONS =======================================================================================
    public static final Supplier<Potion> FREEZE = create(
            "freeze",
            () -> new Potion(new MobEffectInstance(RCMobEffects.FREEZE.get(), 400))
    );
    public static final Supplier<Potion> LONG_FREEZE = create(
            "long_freeze",
            () -> new Potion(new MobEffectInstance(RCMobEffects.FREEZE.get(), 800))
    );
    public static final Supplier<Potion> STRONG_FREEZE = create(
            "strong_freeze",
