...
import com.github.teamfusion.rottencreatures.client.renderer.entity.layers.MummyArmorLayer;
...
public class MummyRenderer<T extends Mummy> extends HumanoidMobRenderer<T, MummyModel<T>> {
    ...
    public MummyRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new MummyArmorLayer<>(this, new MummyModel<>(context.bakeLayer(LAYER.getInner())), new MummyModel<>(context.bakeLayer(LAYER.getOuter()))));
    }
