...
public final class EntityLootGenerator extends SimpleFabricLootTableProvider {
    ...
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        ...
        this.add(RCLootTables.BURNED_OBSIDIAN, consumer, LootTable.lootTable()
            .withPool(LootBuilder.rolls(1)
        ...
        this.add(RCLootTables.UNDEAD_DIAMOND_MINER, consumer, LootTable.lootTable()
        ...
        this.add(RCLootTables.UNDEAD_IRON_MINER, consumer, LootTable.lootTable()
            .withPool(LootBuilder.rolls(0, 3)
                .add(LootBuilder.entry(Items.ROTTEN_FLESH)
                    .apply(LootBuilder.count(0, 2)))
                .add(LootBuilder.entry(Items.COBBLESTONE)
        ...
        this.add(RCLootTables.UNDEAD_STONE_MINER, consumer, LootTable.lootTable()
            .withPool(LootBuilder.rolls(0, 2)
                .add(LootBuilder.entry(Items.ROTTEN_FLESH)
                    .apply(LootBuilder.count(0, 2)))
                .add(LootBuilder.entry(Items.COBBLESTONE)
        ...
        this.add(RCLootTables.UNDEAD_GOLD_MINER, consumer, LootTable.lootTable()
            .withPool(LootBuilder.rolls(0, 2)
                .add(LootBuilder.entry(Items.ROTTEN_FLESH)
                    .apply(LootBuilder.count(0, 2)))
                .add(LootBuilder.entry(Items.COBBLESTONE)
        ...
        this.add(RCLootTables.TREASURE_CHEST, consumer, LootTable.lootTable()
            .withPool(LootBuilder.rolls(1)
                .add(LootBuilder.entry(Items.TOTEM_OF_UNDYING)
                    .when(LootBuilder.chanceWithLooting(0.2F, 0.05F)))
            )
