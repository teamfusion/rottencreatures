...
public class BiomeTagGenerator extends TagsProvider<Biome> {
    ...
    protected void addTags() {
        ...
        this.tag(RCBiomeTags.UNDEAD_MINER.whitelist()).addOptionalTag(BiomeTags.HAS_STRONGHOLD.location());
        this.tag(RCBiomeTags.UNDEAD_MINER.blacklist()).add(Biomes.MUSHROOM_FIELDS);
